...
<div class="form-group">
    ...
    <!-- simplemde -->
    {!! Form::textarea('content', null, ['id' => 'simple-mde', 'class' => 'form-control' . ($errors->has('content') ? ' is-invalid' : ''), 'required']) !!}
...
<script>
    new SimpleMDE({ element: document.getElementById("simple-mde") });
</script>